...
//For custom test
//LD_LIBRARY_PATH=~/programs/project/NFC_device/extras/libndef/libndef ./snep-encode -z ~/programs/project/NFC_device/extras/libndef/app/test.txt "en-US" > ndef1
